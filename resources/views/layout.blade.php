					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 0978119953</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> trannhatban34@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-5">
						<form action="{{URL::to('/tim-kiem')}}" method="post">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" name="search_submit" style="margin-top:0;color:#666" class="btn btn-primary btn-sm" value="Tìm kiếm"/>
							</div>
						</form>
					</div>
				</div>
