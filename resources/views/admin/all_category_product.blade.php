      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/update-category-product/'.$cate_pro->category_id)}}" class="active styling-update" ui-toggle-class="">
                <i class="fa fa-pencil-square-o text-active"></i></a>
              <a onclick="return confirm('Bạn có muốn xóa danh mục sản phẩm này?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-delete" ui-toggle-class="">
